    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
            ...
            child: BigText(text: termsText, textColor: AppColors.lightBlueColor, textSize: Dimension.fontSize25, fontWeight: FontWeight.w700)),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SmallText(text: termAndConditionText, textColor: AppColors.greyLightColor, textSize: Dimension.fontSize14, fontWeight: FontWeight.w400),
            ],
          ),
