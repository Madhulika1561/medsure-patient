...
class FaceNotRecoLoginDialog extends StatelessWidget{
  const FaceNotRecoLoginDialog({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SmallText(text: loginWithUserText, textColor: AppColors.hintTextColor, textSize: Dimension.fontSize14, fontWeight: FontWeight.w500,),
                SizedBox(height: Dimension.height20,),
                buildButtonUI(),
                SizedBox(height: Dimension.height20,),
