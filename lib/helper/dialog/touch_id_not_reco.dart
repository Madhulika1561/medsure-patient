...
class TouchIdNotRecoDialog extends StatelessWidget{
  const TouchIdNotRecoDialog({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: Dimension.height20,),
              SmallText(text: touchIdNotRecoText, textColor: AppColors.blackColor, textSize: Dimension.fontSize16, fontWeight: FontWeight.w500,),
              SizedBox(height: Dimension.height20,),
              buildButtonUI(),
              SizedBox(height: Dimension.height20,),
