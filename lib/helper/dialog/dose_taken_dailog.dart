...
class DoseTakenDialog extends StatelessWidget{
  const DoseTakenDialog({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(AppImages.doseImg,width: 120,height: 120,),
                SizedBox(height: Dimension.height20,),
                SmallText(text: "Dose taken, great job!", textColor: AppColors.blackColor, textSize: Dimension.fontSize16, fontWeight: FontWeight.w500, )
